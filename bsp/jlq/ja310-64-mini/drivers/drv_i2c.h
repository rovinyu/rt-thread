...
struct i2c_adapter {
	rt_int32_t		id;
	rt_int32_t		speed;
    rt_uint32_t scl_muxpin;
    rt_uint32_t sda_muxpin;
};
...
/*
 * It's must be about 200-to 1000ns for sda hold time,
 * 300ns is recommended security value.
 */
#define SDA_HOLD_TIME_NANO	300
...
rt_int32_t rt_hw_i2c_init(void);
